<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:32:"./template/admin/notice_del.html";i:1542675981;s:25:"./template/admin/top.html";i:1542331245;s:30:"./template/admin/leftmenu.html";i:1542675604;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<section id="main" class="column">
    <form id="form1" name="form1" method="post" action="/del_notice">
	<article class="module width_full">
		<header><h3>公告删除</h3></header>
			   <div class="module_content">
				<fieldset>
						<label>标题</label>
							确定要删除 <?php echo $data['title']; ?>这条公告吗？
				</fieldset>				
             </div>
		<footer>
