<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:34:"./template/admin/activeupdate.html";i:1542634354;s:25:"./template/admin/top.html";i:1542331245;s:30:"./template/admin/leftmenu.html";i:1542675604;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin.html">后台管理系统</a> <div class="breadcrumb_divider"></div> <a class="current">活动修改</a></article>
		</div>
...
<section id="main" class="column">
	...
	<form id="form1" name="form1" method="post" action="/update_active">
	<article class="module width_full">
		<header><h3>活动修改</h3></header>
			   <div class="module_content">
                ...
                <fieldset style="width:96%;margin-right: 3%;">
					    <label>图片</label>
							<input type="text" name="activephoto" style="width:92%;height:40px;font-size:18px;" value="<?php echo $data['activephoto']; ?>">
				</fieldset><div class="clear"></div>
                <fieldset style="width:96%;margin-right: 3%;">
						<label>内容</label>
