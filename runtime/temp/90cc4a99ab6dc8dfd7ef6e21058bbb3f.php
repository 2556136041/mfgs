<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:29:"./template/admin/mes_del.html";i:1536587640;s:25:"./template/admin/top.html";i:1536497942;s:30:"./template/admin/leftmenu.html";i:1536761121;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin.html">后台管理系统</a> <div class="breadcrumb_divider"></div> <a class="current">留言删除</a></article>
		</div>
...
<section id="main" class="column">
    <form id="form1" name="form1" method="post" action="/del_mes">
	<article class="module width_full">
		<header><h3>留言删除</h3></header>
			   <div class="module_content">
				<fieldset>
						<label>名称</label>
							确定要删除 <?php echo $data['title']; ?>这条留言吗？
				</fieldset>				
             </div>
		<footer>
