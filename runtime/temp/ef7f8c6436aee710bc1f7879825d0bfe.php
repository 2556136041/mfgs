<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:32:"./template/admin/pcuserlist.html";i:1542848867;s:25:"./template/admin/top.html";i:1542331245;s:30:"./template/admin/leftmenu.html";i:1542781198;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
				...
				<table class="tablesorter" cellspacing="0" style="margin:0"> 
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$value): ?>
						<tr>
                                ...
                                <td style="word-wrap:break-word;word-break:break-all;"><?php echo $value['email']; ?></td>
                                <td><?php echo $value['address']; ?></td>
                                <td style="word-wrap:break-word;word-break:break-all;"><?php echo $value['regtime']; ?></td>
			    				<td>
                                <?php if($value['class'] == 1): ?>
                                <font color='red'>管理员</font>
                                <?php elseif($value['class'] == 2): ?><font color='red'>超级管理员</font>
                                <?php else: ?>
                                一般用户
                                <?php endif; ?>
                                </td> 
			    				<td><input type="image" src="__img__/icn_edit.png" title="Edit" onClick="window.location.href='/pcuserupdate/id/<?php echo $value['id']; ?>'"><input type="image" src="__img__/icn_trash.png" title="Trash" onClick="window.location.href='/pcuserdel/id/<?php echo $value['id']; ?>'"></td>
						</tr>
