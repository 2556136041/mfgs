<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./template/leavemessage/lookleaveword.html";i:1594471932;s:32:"./template/leavemessage/top.html";i:1594471932;s:35:"./template/leavemessage/bottom.html";i:1594471933;}*/ ?>
...
<tr>
    <td width="100" align="center">
        <img width="80%" src="<?php echo (isset($mesinfo['personinfo']['photo']) && ($mesinfo['personinfo']['photo'] !== '')?$mesinfo['personinfo']['photo']:''); ?>" alt="" />
        <br>
        <p style="text-align: center;">
               <?php echo (isset($mesinfo['personinfo']['username']) && ($mesinfo['personinfo']['username'] !== '')?$mesinfo['personinfo']['username']:''); ?>
		</p>
    </td>
    <td width="580" valign="top">留言：<?php echo $mesinfo['content']; ?></td>
</tr>
