<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"./app/admin/view/index/publicnewsdatalogin.html";i:1593011548;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
<meta charset="UTF-8">
<title>submitpublicnewsdata</title>
<style>
	   	    	...
	   	    	$.ajax({
					...
					success:function(result){
						if(result==0){
			                ...
			                $("#form1").attr("action",'/admin/publicnewsdata');
			            }
					}
	            });
	   	    }		   	    
