<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"./template/admin/story_del.html";i:1542681491;s:25:"./template/admin/top.html";i:1542331245;s:30:"./template/admin/leftmenu.html";i:1542675604;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin.html">后台管理系统</a> <div class="breadcrumb_divider"></div> <a class="current">分享删除</a></article>
		</div>
...
<section id="main" class="column">
    <form id="form1" name="form1" method="post" action="/del_story">
	<article class="module width_full">
		<header><h3>分享删除</h3></header>
			   <div class="module_content">
				<fieldset>
						<label>标题</label>
							确定要删除 <?php echo $data['title']; ?>这条分享吗？
				</fieldset>				
             </div>
		<footer>
