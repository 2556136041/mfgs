<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:31:"./template/admin/storylist.html";i:1542726912;s:25:"./template/admin/top.html";i:1542331245;s:30:"./template/admin/leftmenu.html";i:1542781198;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin.html">后台管理中心</a> <div class="breadcrumb_divider"></div> <a class="current">分享公告</a></article>
		</div>
...
<aside id="sidebar" class="column">
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">分享管理列表</h3>
		</header>
				...
				<table class="tablesorter" border="0" cellspacing="0" style="margin:0"> 
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$value): ?>
						<tr>
			    				...
			    				<td align="left" valign="top"><?php echo $value['title']; ?></td> 
			    				<td align="left" valign="top"><?php echo $value['content']; ?></td> 
			    				<td align="left" valign="top">
                                <ul class="hoverbox">
			    				<li>
                                <a href="#"><img height="40px" src="__img__/story/<?php echo $value['storyphoto']; ?>"><img src="__img__/story/<?php echo $value['storyphoto']; ?>" alt="" class="preview"></a>
                                </li>
                                </ul>                                
                                </td> 
			    				<td align="left" valign="top"><?php echo $value['hits']; ?></td> 
			    				...
			    				<td align="left" valign="top"><input type="image" src="__img__/icn_edit.png" title="Edit" onClick="window.location.href='/storyupdate/id/<?php echo $value['id']; ?>'"><input type="image" src="__img__/icn_trash.png" title="Trash" onClick="window.location.href='/story_del/id/<?php echo $value['id']; ?>'"></td>
						</tr>
