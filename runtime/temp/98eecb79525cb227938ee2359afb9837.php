<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:28:"./template/admin/mes_sh.html";i:1537086749;s:25:"./template/admin/top.html";i:1536976599;s:30:"./template/admin/leftmenu.html";i:1537018472;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<body>
	...
	<header id="header">
		<p id="p_top_l"><a href="/index.html"><img src="__img__/logo11.png" width="250px" height="75px" align="middle" /></a></p>
		<p id="p_top_r">后台管理</p>
...
<aside id="sidebar" class="column">
	...
	<h3>用户管理</h3>
	<ul class="toggle">
		<li class="icn_categories"><a href="/userlist">管理用户</a></li>
	</ul>
	<h3>留言管理</h3>
	<ul class="toggle">
...
<section id="main" class="column">
    <form id="form1" name="form1" method="post" action="/sh_mes">
	<article class="module width_full">
		<header><h3>审核留言</h3></header>
			   <div class="module_content">
				<fieldset>
						<label>名称</label>
							由<?php echo $data['personinfo']['username']; ?>提交的<?php echo $data['title']; ?>
				</fieldset>
                <fieldset>
						<label>审核</label>
							通过审核<input type="radio" name="state" value='1'>未通过审核<input type="radio" checked="" name="state" value='0'>
				</fieldset>
		...
		<footer>
			<div class="submit_link">
				...
				<input type="hidden" name="createtime" value="<?php echo $data['createtime']; ?>">
