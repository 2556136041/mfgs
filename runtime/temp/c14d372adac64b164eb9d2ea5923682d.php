<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:34:"./template/admin/complainlist.html";i:1542849576;s:25:"./template/admin/top.html";i:1542331245;s:30:"./template/admin/leftmenu.html";i:1542781198;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin.html">后台管理中心</a> <div class="breadcrumb_divider"></div> <a class="current">投诉处理</a></article>
		</div>
				...
				<table class="tablesorter" cellspacing="0" style="margin:0"> 
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$value): ?>
						<tr>
                                ...
                                <td><?php echo $value['complainuser']; ?></td> 
                                <td><?php echo $value['state']; ?></td> 
                                <td style="width:10%;word-wrap: break-word;word-break: break-all;"><?php echo $value['explain']; ?></td> 
			    				<td><?php echo $value['num']; ?></td> 
			    				<td style="width:10%;word-wrap: break-word;word-break: break-all;"><?php echo $value['complaintime']; ?></td>
			    				<td><input type="image" src="__img__/icn_edit.png" title="Edit" onClick="window.location.href='/complainupdate/id/<?php echo $value['id']; ?>'"><!-- <input type="image" src="__img__/icn_trash.png" title="Trash" onClick="window.location.href='/wish_del/id/<?php echo $value['id']; ?>'"> --></td>
						</tr>
