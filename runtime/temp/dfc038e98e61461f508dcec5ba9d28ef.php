<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:29:"./template/admin/pro_pos.html";i:1542015369;s:25:"./template/admin/top.html";i:1537931579;s:30:"./template/admin/leftmenu.html";i:1541985692;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin.html">后台管理系统</a> <div class="breadcrumb_divider"></div> <a class="current">产品位置</a></article>
		</div>
...
<section id="main" class="column">
    <form id="form1" name="form1" method="post" action="/pos_pro">
	<article class="module width_full">
		<header><h3>产品位置</h3></header>
			   <div class="module_content">
                ...
                <fieldset>
						<label>位置</label>
							封面<input type="radio" name="pos" value='1'>正常<input type="radio" checked="" name="pos" value='0'>
				</fieldset>
