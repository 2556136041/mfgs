<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:36:"./template/admin/complainupdate.html";i:1542680437;s:25:"./template/admin/top.html";i:1542331245;s:30:"./template/admin/leftmenu.html";i:1542675604;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin.html">后台管理系统</a> <div class="breadcrumb_divider"></div> <a class="current">处理意见</a></article>
		</div>
...
<section id="main" class="column">
	...
	<form id="form1" name="form1" method="post" action="/update_complain.html">
	<article class="module width_full">
		<header><h3>处理意见</h3></header>
			   <div class="module_content">
                <fieldset style="width:48%;float:left;">
					    <label>被投诉人</label>
							<input type="text" name="complainuser" style="width:92%;height:40px;font-size:18px;" value="<?php echo $data['complainuser']; ?>">
				...
				<fieldset style="width:96%;">
					    <label>是否列为黑名单</label>
							<input placeholder="0未处理，1处理" type="text" name="state" style="width:92%;height:40px;font-size:18px;" value="<?php echo $data['state']; ?>">
				</fieldset><div class="clear"></div>				
		...
		<footer>
			<div class="submit_link">
                ...
                <input type="hidden" name="explain" value="<?php echo $data['explain']; ?>">
                <input type="hidden" name="userid" value="<?php echo $data['userid']; ?>">
				<input type="submit" name="submit" value="确认" class="alt_btn">
			</div>
		</footer>
	</article>
	</form>
