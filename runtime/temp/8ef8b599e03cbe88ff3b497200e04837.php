<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:27:"./template/admin/index.html";i:1542674294;s:25:"./template/admin/top.html";i:1542331245;s:30:"./template/admin/leftmenu.html";i:1542781198;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin.html">后台管理中心</a> <div class="breadcrumb_divider"></div> <a class="current">首页</a></article>
		</div>
	...
	<section id="main" class="column">
		<article class="module width_full">
			...
			<div class="module_content">
				<p>本站共有产品<?php echo (isset($prototal) && ($prototal !== '')?$prototal:'0'); ?>件</p>				
				<p>本站共有电脑端用户<?php echo (isset($usertotal) && ($usertotal !== '')?$usertotal:'0'); ?>个</p>
        <p>本站共有手机用户<?php echo (isset($wxusertotal) && ($wxusertotal !== '')?$wxusertotal:'0'); ?>个</p>
				<div class="clear"></div>
			</div>
