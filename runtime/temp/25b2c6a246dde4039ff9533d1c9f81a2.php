<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:32:"./template/admin/wishupdate.html";i:1542678325;s:25:"./template/admin/top.html";i:1542331245;s:30:"./template/admin/leftmenu.html";i:1542675604;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin.html">后台管理系统</a> <div class="breadcrumb_divider"></div> <a class="current">寄语修改</a></article>
		</div>
...
<section id="main" class="column">
	...
	<form id="form1" name="form1" method="post" action="/update_wish.html">
	<article class="module width_full">
		<header><h3>寄语修改</h3></header>
			   <div class="module_content">
                ...
                <fieldset style="width:96%;margin-right: 3%;">
						<label>内容</label>
						<textarea type="text" name="artical" style="width:92%;height:100px;font-size:18px;" value="<?php echo $data['artical']; ?>"><?php echo $data['artical']; ?></textarea>
				</fieldset><div class="clear"></div>
				<fieldset style="width:48%;margin-right: 3%;float:left;">
						<label>相片</label>
						<input disabled type="text" name="photo" style="width:92%;height:40px;font-size:18px;" value="<?php echo $data['photo']; ?>">
				</fieldset><fieldset style="width:48%;margin-right: 3%;float:left;">
						<label>视频</label>
						<input disabled type="text" name="video" style="width:92%;height:40px;font-size:18px;" value="<?php echo $data['video']; ?>">
				</fieldset><div class="clear"></div>
