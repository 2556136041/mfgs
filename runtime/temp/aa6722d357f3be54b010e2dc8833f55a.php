<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:29:"./template/admin/meslist.html";i:1542683760;s:25:"./template/admin/top.html";i:1542331245;s:30:"./template/admin/leftmenu.html";i:1542781198;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin.html">后台管理中心</a> <div class="breadcrumb_divider"></div> <a class="current">管理留言</a></article>
		</div>
				...
				<table class="tablesorter" cellspacing="0" style="margin:0" border="0"> 
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$value): ?>
						<tr>
			    				...
			    				<td valign='top'><?php echo $value['userid']; ?></td> 
			    				<td valign='top'><?php echo $value['title']; ?></td> 
                                <td valign='top'><?php echo $value['content']; ?></td>
			    				<td valign='top'><?php echo $value['createtime']; ?></td> 
			    				<td valign='top'><?php echo $value['state']; ?></td> 
			    				<td align="left"><input type="image" src="__img__/icn_alert_success.png" title="Edit" onClick="window.location.href='/mes_sh/id/<?php echo $value['id']; ?>'"><input type="image" src="__img__/icn_trash.png" title="Trash" onClick="window.location.href='/mesdel/id/<?php echo $value['id']; ?>'"></td>
						</tr>
