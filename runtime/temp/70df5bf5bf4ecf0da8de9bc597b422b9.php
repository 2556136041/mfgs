<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:32:"./template/admin/activelist.html";i:1542727108;s:25:"./template/admin/top.html";i:1542331245;s:30:"./template/admin/leftmenu.html";i:1542781198;}*/ ?>
<!doctype html>
<html>
<head>
	<meta charset="utf-8"/>
...
<body>
	...
	<section id="secondary_bar">
		...
		<div class="breadcrumbs_container">
			<article class="breadcrumbs"><a href="/admin.html">后台管理中心</a> <div class="breadcrumb_divider"></div> <a class="current">管理活动</a></article>
		</div>
...
<aside id="sidebar" class="column">
	...
	<section id="main" class="column">
		...
		<header><h3 class="tabs_involved">活动管理列表</h3>
		</header>
			...
			<div id="tab1" class="tab_content">
				<table class="tablesorter" cellspacing="0" style="margin:0"> 
					...
					<?php if(is_array($list) || $list instanceof \think\Collection || $list instanceof \think\Paginator): if( count($list)==0 ) : echo "" ;else: foreach($list as $key=>$value): ?>
						<tr>
                                <td align="left" valign="top"><?php echo $value['id']; ?></td>
			    				<td align="left" valign="top"><?php echo $value['username']; ?></td> 
			    				<td width="10%" align="left" valign="top"><?php echo $value['title']; ?></td> 
                                <td align="left" valign="top">
                                <ul class="hoverbox">
			    				<li>
                                <a href="#"><img height="40px" src="__img__/active/<?php echo $value['activephoto']; ?>"><img src="__img__/active/<?php echo $value['activephoto']; ?>" alt="" class="preview"></a>
                                </li>
                                </ul>
                                </td> 
			    				<td width="30%" style="text-align:justify;" align="left" valign="top"><?php echo $value['content']; ?></td> 
			    				<td align="left" valign="top"><?php echo $value['pubtime']; ?></td> 
                                <td align="left" valign="top"><?php echo $value['state']; ?></td> 
			    				<td align="left" valign="top"><?php echo $value['pos']; ?></td> 
			    				<td align="left" valign="top"><input type="image" src="__img__/icn_edit.png" title="Edit" onClick="window.location.href='/activeupdate/id/<?php echo $value['id']; ?>'"><input type="image" src="__img__/icn_trash.png" title="Trash" onClick="window.location.href='/active_del/id/<?php echo $value['id']; ?>'"></td>
						</tr>
